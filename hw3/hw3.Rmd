...
According to the plot below, we find that we get the best result when the number of knots is 2.
Based on the fitted splines plot of each variables, we find that temperature is linear where radiation and wind are not.
...
We suspect that the non-linearity we observed in fitted spline plots above is a result of small sample size.
